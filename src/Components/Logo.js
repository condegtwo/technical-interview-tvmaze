    ...
    >
      <defs>
        <linearGradient
          ...
          y1="-288.84"
          y2="-275.26"
          gradientTransform="translate(-31.161 -22.363) scale(.89408)"
        ...
        <linearGradient
          ...
          y1="-148.14"
          y2="58.862"
          gradientTransform="matrix(-.87659 .5061 .5061 .87659 464.45 536.91)"
          gradientUnits="userSpaceOnUse"
          xlinkHref="#linearGradient3829"
        ></linearGradient>
        <linearGradient id="linearGradient3829">
          <stop offset="0" stopColor="#989a96"></stop>
        ...
        <linearGradient
          ...
          y1="-148.14"
          y2="58.862"
          gradientTransform="rotate(-30 1343.986 -184.982)"
          gradientUnits="userSpaceOnUse"
          xlinkHref="#linearGradient3829"
        ></linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0" stopColor="#888a85"></stop>
          <stop offset="1" stopColor="#eeeeec"></stop>
        </linearGradient>
        <linearGradient
        ...
        >
          ...
          <stop offset="1" stopColor="#babdb6"></stop>
        </linearGradient>
        <linearGradient
      ...
      <g transform="translate(-225.48 -436.83)">
        <g transform="translate(187.37 1052.2)">
          ...
          <path
            ...
            strokeWidth="2"
            d="M174-458.64c0 55.781-45.219 101-101 101s-101-45.219-101-101 45.219-101 101-101 101 45.219 101 101z"
            transform="scale(.74895) rotate(29.537 518.011 -278.525)"
          ></path>
          <path
            fill="none"
            stroke="url(#linearGradient3905)"
            ...
            strokeWidth="2"
            d="M174-458.64c0 55.781-45.219 101-101 101s-101-45.219-101-101 45.219-101 101-101 101 45.219 101 101z"
            transform="rotate(29.537 439.958 -185.665) scale(.68658)"
          ></path>
          <path
            fill="none"
            stroke="url(#linearGradient3905)"
            ...
            strokeWidth="2"
            d="M174-458.64c0 55.781-45.219 101-101 101s-101-45.219-101-101 45.219-101 101-101 101 45.219 101 101z"
            transform="rotate(29.537 497.712 -160.168) scale(.61726)"
          ></path>
          <path
            fill="none"
            stroke="url(#linearGradient3905)"
        ...
        <path
          ...
          strokeLinejoin="round"
          strokeWidth="2"
          d="M295.67 462.13a6.008 6.008 0 00-2.844.813c-2.878 1.662-3.88 5.308-2.219 8.187l32.188 63.594a38.157 38.157 0 00-9.812 16.969l-71.156 3.969c-1.247 0-2.418.354-3.375 1-1.596 1.076-2.625 2.922-2.625 5 0 3.324 2.676 6 6 6l71.156 3.969a38.18 38.18 0 009.781 16.969l-32.125 63.594a5.974 5.974 0 002.188 8.187 5.974 5.974 0 008.187-2.187l38.97-59.656a38.37 38.37 0 0019.655 0l38.97 59.656c1.661 2.878 5.34 3.85 8.218 2.187s3.85-5.309 2.188-8.187L376.859 588.6a38.17 38.17 0 009.78-16.97l71.189-3.968c3.324 0 5.969-2.676 5.969-6s-2.645-6-5.97-6l-71.187-3.969a38.176 38.176 0 00-9.781-16.969l32.156-63.594c1.662-2.879.66-6.525-2.22-8.187a5.962 5.962 0 00-6.124.062c-.824.506-1.512 1.225-2.031 2.125l-39 59.656a38.13 38.13 0 00-9.813-1.281c-3.383 0-6.689.424-9.812 1.25l-39-59.625a5.967 5.967 0 00-5.344-3zm54.125 65.312c18.898 0 34.219 15.32 34.219 34.219 0 18.898-15.32 34.219-34.219 34.219-18.898 0-34.188-15.32-34.188-34.219 0-18.898 15.289-34.219 34.188-34.219z"
          opacity="0.8"
        ></path>
        <path
        ...
        <path
          ...
          strokeLinejoin="round"
          strokeWidth="2"
          d="M387.62 551.62c-1.77-6.496-5.19-12.345-9.813-16.969l32-63.656a5.984 5.984 0 00-2.218-8.188 6.094 6.094 0 00-1.438-.593M361.182 523.776l-.625.968a38.108 38.108 0 00-9.812-1.25 38.43 38.43 0 00-9.813 1.282l-39.125-59.562a5.939 5.939 0 00-5.344-2.97 6.007 6.007 0 00-2.843.813c-.32.186-.634.395-.907.625m85.19 124.842a38.107 38.107 0 009.75-16.97l71.188-4.124c3.324-.007 5.945-2.708 5.938-6.032-.007-3.324-2.645-5.975-5.969-5.968m-107.906 44.374a38.144 38.144 0 009.813-1.312l39.094 59.594c1.668 2.875 5.343 3.824 8.218 2.156m-95.469-88.594l1.438.063a38.136 38.136 0 009.812 16.938l-31.969 63.656c-1.656 2.882-.694 6.531 2.188 8.187m29.719-125.75v.032a38.198 38.198 0 00-9.781 17l-71.156 4.093a6.048 6.048 0 00-3.375 1.032c-1.594 1.079-2.599 2.922-2.594 5 0 .24.004.486.031.718m113.84-35.187c18.898-.04 34.241 15.258 34.281 34.156.04 18.898-15.227 34.241-34.125 34.281-18.898.04-34.21-15.258-34.25-34.156-.04-18.898 15.195-34.24 34.094-34.28z"
          opacity="0.8"
        ></path>
        <g transform="translate(329.37 838.22)">
          <path
            ...
            opacity="0.5"
            transform="translate(-16.858 -37.358) scale(.76641)"
          ></path>
          <path
            fill="#fff"
            d="M62.225-308.82c0 6.248-5.065 11.314-11.314 11.314-6.248 0-11.314-5.065-11.314-11.314 0-6.248 5.065-11.314 11.314-11.314 6.248 0 11.314 5.065 11.314 11.314z"
            transform="translate(-14.483 -65.069) scale(.68523)"
          ></path>
          <path
            fill="#2e3436"
            d="M20.36-282.36c-2.968 0-5.364 2.425-5.364 5.392a5.337 5.337 0 004.107 5.197v3.325h2.514v-3.325a5.337 5.337 0 004.107-5.197c0-2.967-2.396-5.392-5.364-5.392z"
          ></path>
          <path
            fill="url(#linearGradient3954)"
            d="M17.587-268.82c-1.265-.455-2.17-1.039-3.187-2.056-1.047-1.047-1.6-1.92-2.055-3.243-1.84-5.347 2.283-11.14 7.929-11.14 2.363 0 4.4.833 6.032 2.464 1.687 1.687 2.477 3.585 2.477 5.954 0 2.407-.792 4.304-2.529 6.06-.924.933-2.887 2.02-3.99 2.21l-.593.101v-3.146l.592-.184c2.103-.653 3.694-3.168 3.458-5.466-.202-1.96-1.417-3.643-3.241-4.49-1.259-.583-3.044-.586-4.287-.006-2.79 1.304-3.989 4.683-2.619 7.387.481.95 1.7 2.086 2.658 2.48l.75.308.001 1.541c0 1.765.03 1.74-1.396 1.226z"
          ></path>
        </g>
      </g>
    </svg>
